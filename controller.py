...
class controller:
    ...
    def __init__(self, type, klp, klv, kli, kap, kav, kai):
        
        # TODO Part 5 and 6: Modify the below lines to test your PD, PI, and PID controller
        self.PID_linear=PID_ctrl(type, klp, klv, kli, filename_="linear.csv")
        self.PID_angular=PID_ctrl(type, kap, kav, kai, filename_="angular.csv")
...
class trajectoryController(controller):
    ...
    def __init__(self, klp=0.2, klv=0.2, kli=0.2, kap=0.2, kav=0.2, kai=0.2):
        ...
        super().__init__(PID, klp, klv, kli, kap, kav, kai)
